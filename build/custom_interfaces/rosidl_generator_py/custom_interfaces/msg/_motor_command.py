...
class MotorCommand(metaclass=Metaclass_MotorCommand):
    ...
    _fields_and_field_types = {
        ...
        'target_position': 'sequence<int32>',
        'target_velocity_profile': 'sequence<int32>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.target_position = array.array('i', kwargs.get('target_position', []))
        self.target_velocity_profile = array.array('i', kwargs.get('target_velocity_profile', []))
    ...
    def target_position(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'target_position' array.array() must have the type code of 'i'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'target_position' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._target_position = array.array('i', value)
    ...
    def target_velocity_profile(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'target_velocity_profile' array.array() must have the type code of 'i'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -2147483648 and val < 2147483648 for val in value)), \
                "The 'target_velocity_profile' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._target_velocity_profile = array.array('i', value)
