...
#ifndef CUSTOM_INTERFACES__SRV__DETAIL__MOVE_MOTOR_DIRECT__FUNCTIONS_H_
#define CUSTOM_INTERFACES__SRV__DETAIL__MOVE_MOTOR_DIRECT__FUNCTIONS_H_
...
/// Initialize srv/MoveMotorDirect message.
/**
...
/// Finalize srv/MoveMotorDirect message.
/**
...
/// Create srv/MoveMotorDirect message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__MoveMotorDirect_Request__init().
...
/// Destroy srv/MoveMotorDirect message.
/**
 * It calls
 * custom_interfaces__srv__MoveMotorDirect_Request__fini()
...
/// Check for srv/MoveMotorDirect message equality.
/**
...
/// Copy a srv/MoveMotorDirect message.
/**
...
/// Initialize array of srv/MoveMotorDirect messages.
/**
...
/// Finalize array of srv/MoveMotorDirect messages.
/**
 * It calls
 * custom_interfaces__srv__MoveMotorDirect_Request__fini()
...
/// Create array of srv/MoveMotorDirect messages.
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__MoveMotorDirect_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveMotorDirect messages.
/**
 * It calls
 * custom_interfaces__srv__MoveMotorDirect_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveMotorDirect message array equality.
/**
...
/// Copy an array of srv/MoveMotorDirect messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__MoveMotorDirect_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__MoveMotorDirect_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__MoveMotorDirect_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__MoveMotorDirect_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACES__SRV__DETAIL__MOVE_MOTOR_DIRECT__FUNCTIONS_H_
