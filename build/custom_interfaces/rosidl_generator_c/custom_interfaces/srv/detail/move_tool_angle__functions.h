...
#ifndef CUSTOM_INTERFACES__SRV__DETAIL__MOVE_TOOL_ANGLE__FUNCTIONS_H_
#define CUSTOM_INTERFACES__SRV__DETAIL__MOVE_TOOL_ANGLE__FUNCTIONS_H_
...
/// Initialize srv/MoveToolAngle message.
/**
...
/// Finalize srv/MoveToolAngle message.
/**
...
/// Create srv/MoveToolAngle message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__MoveToolAngle_Request__init().
...
/// Destroy srv/MoveToolAngle message.
/**
 * It calls
 * custom_interfaces__srv__MoveToolAngle_Request__fini()
...
/// Check for srv/MoveToolAngle message equality.
/**
...
/// Copy a srv/MoveToolAngle message.
/**
...
/// Initialize array of srv/MoveToolAngle messages.
/**
...
/// Finalize array of srv/MoveToolAngle messages.
/**
 * It calls
 * custom_interfaces__srv__MoveToolAngle_Request__fini()
...
/// Create array of srv/MoveToolAngle messages.
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__MoveToolAngle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveToolAngle messages.
/**
 * It calls
 * custom_interfaces__srv__MoveToolAngle_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveToolAngle message array equality.
/**
...
/// Copy an array of srv/MoveToolAngle messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__MoveToolAngle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__MoveToolAngle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__MoveToolAngle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__MoveToolAngle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACES__SRV__DETAIL__MOVE_TOOL_ANGLE__FUNCTIONS_H_
