...
#include "custom_interfaces/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // target_position, target_velocity_profile
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // target_position, target_velocity_profile
...
using _MotorCommand__ros_msg_type = custom_interfaces__msg__MotorCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->target_velocity_profile.size;
    auto array_ptr = ros_message->target_velocity_profile.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: target_position
  {
    ...
    if (ros_message->target_position.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->target_position);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->target_position, size)) {
  ...
  // Field name: target_velocity_profile
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->target_velocity_profile.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->target_velocity_profile);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->target_velocity_profile, size)) {
      fprintf(stderr, "failed to create array for field 'target_velocity_profile'");
      return false;
    }
    auto array_ptr = ros_message->target_velocity_profile.data;
    cdr.deserializeArray(array_ptr, size);
...
size_t get_serialized_size_custom_interfaces__msg__MotorCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorCommand__ros_msg_type * ros_message = static_cast<const _MotorCommand__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name target_velocity_profile
  {
    size_t array_size = ros_message->target_velocity_profile.size;
    auto array_ptr = ros_message->target_velocity_profile.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
...
static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__MotorCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__MotorCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MotorCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__MotorCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, MotorCommand)() {
